...
@Autonomous(name="Blue Side 12 Ball", group="AAAAAAA")
public class BlueSideAutonomous extends CommandOpMode {
    ...
    // Poses
    private final Pose startPose = new Pose(24.750, 140.000, Math.toRadians(135.000));
    ...
    public void buildPaths() {
         StartToShoot0 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(24.750, 145.000), new Pose(44.750, 112.000))
                )
         ...
         Shoot0ToIntake1 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(44.750, 112.000), new Pose(45.000, 95.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180))
                .build();

         Intake1Through = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(45.000, 95.000), new Pose(15.000, 95.000)))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();

         EndIntakeToShoot1 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(15.000, 95.000), new Pose(50.000, 95.000)))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(135))
                .build();

         Shoot1ToIntake2 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(50.000, 95.000), new Pose(45.000, 70.000)))
                .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180))
                .build();

         Intake2Through = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(45.000, 70.000), new Pose(7.500, 70.000)))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();

         EndIntakeToShoot2 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(7.500, 70.000), new Pose(70.000, 80.000)))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(135))
                .build();

         Shoot2ToIntake3 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(70.000, 80.000), new Pose(50.000, 48.750)))
                .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180))
                .build();

         Intake3Through = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(50.000, 48.750), new Pose(10.000, 48.750)))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();

         EndIntakeToShoot3 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(10.000, 48.750), new Pose(70.000, 80.000)))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(135))
                .build();
    }
...
//                new WaitCommand((long) 1000),
    ...
    public void initialize() {
        ...
        SequentialCommandGroup autonomousSequence = new SequentialCommandGroup(
                //Preloads
                moveAndPrepareFlywheel(StartToShoot0, 30.0, 0.60, 1.0),
                ...
                moveAndPrepareFlywheel(EndIntakeToShoot1, 29.0, 0.625, 1.0),
                ...
                new InstantCommand(m_intake::lockGate).withTimeout(150)
                        .deadlineWith( new RunCommand(()->m_intake.setDutyCycle(1.0))),
                moveAndPrepareFlywheel(EndIntakeToShoot2, 32.0, 0.74, 1.0),
                ...
                new InstantCommand(m_intake::lockGate).withTimeout(150)
                .deadlineWith( new RunCommand(()->m_intake.setDutyCycle(1.0))),
                moveAndPrepareFlywheel(EndIntakeToShoot3, 32.0, 0.74, 1.0),
        ...
        SequentialCommandGroup autonomousWithTurretAdjustmentAndAbort = new SequentialCommandGroup(
                autonomousWithTurretAdjustment.withTimeout((long) (29.5*1000.0))
                        .andThen(new FollowPathCommand(follower, follower.pathBuilder()
                                .addPath(new BezierLine(follower.getPose(), new Pose(55, 55)))
